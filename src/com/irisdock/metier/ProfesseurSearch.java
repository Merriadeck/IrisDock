...
public class ProfesseurSearch {
	public static void invoke(DAOFactory factory)
	{
		...
		answerProfesseur = (String) JOptionPane.showInputDialog(null,
				"Sélectionner le professeur à afficher",
				"Sélection du professeur",
		...
		Professeur selectProfesseur = factory.getProfDAO().findProfesseur(loginProfesseur);
		
		JOptionPane.showMessageDialog(null, selectProfesseur.toString(), "Informations professeur",JOptionPane.INFORMATION_MESSAGE);
	}
